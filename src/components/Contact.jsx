...
function Contact() {
    return (
        <div id="Contact" className="w-[100%] h-[20vh] bg-[#DD5746] flex justify-evenly max-sm:flex-col gap-y-[1rem] max-sm:h-[fit-content]  items-center p-[20px] shadow-inset-less">
